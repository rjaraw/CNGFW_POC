...
locals {
  ...
  kayana_private_sub_a_cidr = data.terraform_remote_state.aws_infra_and_rulestacks.outputs.kayana_pri_sub_a_cidr
  kayana_private_sub_b_cidr = data.terraform_remote_state.aws_infra_and_rulestacks.outputs.kayana_pri_sub_b_cidr
  kayana_private_sub_c_cidr = data.terraform_remote_state.aws_infra_and_rulestacks.outputs.kayana_pri_sub_c_cidr
